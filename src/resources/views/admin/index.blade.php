...
<div ng-app="typicms" ng-cloak ng-controller="ListController" ng-show="!initializing">
    ...
    <h1>
        <span>@{{ totalModels }} @choice('partners::global.partners', 2)</span>
    </h1>
    ...
    <div class="table-responsive">
        ...
        <table st-persist="partnersTable" st-table="displayedModels" st-order st-sort-default="position" st-pipe="callServer" st-filter class="table table-condensed table-main">
            <thead>
                <tr>
